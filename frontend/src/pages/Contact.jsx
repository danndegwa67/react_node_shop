function Contact() {
    return (
      <div class="container py-5">
        <div class="row g-4">
          <div class="col-md-5">
            <div class="card border-0 shadow-sm p-4 bg-dark text-white rounded-3 h-100">
            ...
            <div class="card border-0 shadow-sm p-4 bg-white rounded-3 h-100">
              ...
              <form onSubmit={(e) => e.preventDefault()}>
                <div class="mb-3">
                  ...
                  <input type="text" class="form-control" placeholder="Joshua Agutu" required />
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                  ...
                  <textarea class="form-control" rows="4" placeholder="List the component names or specific vehicle models you are maintaining..." required></textarea>
                </div>
                <button type="submit" class="btn btn-primary fw-bold px-4">Send Verification Request</button>
              </form>
            </div>
          </div>
        </div>
